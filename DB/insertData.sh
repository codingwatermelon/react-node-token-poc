...
psql -U postgres -d joeyshomes -a -c "\copy propertiesgeneraldetails(id, image_path, purchase_date) FROM 'data_files/PropertiesGeneralDetails.csv' DELIMITER ',' CSV HEADER"
