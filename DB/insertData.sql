...
FROM '/home/jack/joeyshomes/DB/data_files/Properties.csv'
DELIMITER ','
CSV HEADER;

copy propertiesgeneraldetails(image_path, purchase_date)
FROM '/home/jack/joeyshomes/DB/data_files/PropertiesGeneralDetails.csv'
DELIMITER ','
CSV HEADER;
...
FROM '/home/jack/joeyshomes/DB/data_files/PropertiesFinancialDetails.csv' 
DELIMITER ',' 
CSV HEADER;

copy propertiesmaintenance(properties_id, maintenance_name, cost, maintenance_type, due_date)
FROM '/home/jack/joeyshomes/DB/data_files/PropertiesMaintenance.csv'
DELIMITER ',' 
CSV HEADER;