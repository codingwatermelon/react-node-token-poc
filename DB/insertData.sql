...
FROM '/home/jack/joeyshomes/DB/data_files/Properties-Table 1.csv'
DELIMITER ','
CSV HEADER
QUOTE '\"';

copy propertiesgeneraldetails(image_path, purchase_date)
FROM '/home/jack/joeyshomes/DB/data_files/PropertiesGeneralDetails-Table 1.csv'
DELIMITER ','
CSV HEADER
QUOTE '\"';
...
FROM '/home/jack/joeyshomes/DB/data_files/PropertiesFinancialDetails-Table 1.csv' 
DELIMITER ',' 
CSV HEADER
QUOTE '\"';

copy propertiesmaintenance(properties_id, maintenance_name, cost, maintenance_type, due_date)
FROM '/home/jack/joeyshomes/DB/data_files/PropertiesMaintenance-Table 1.csv'
DELIMITER ',' 
CSV HEADER 
QUOTE '\"';